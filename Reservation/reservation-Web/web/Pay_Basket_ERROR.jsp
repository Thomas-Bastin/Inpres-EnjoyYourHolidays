        ...
        <div class="container">
            ...
            <form action="Pay_Basket" method="POST" id="PayForm">
                <div class="input-group mb-3">
                    ...
                    <%
                       String val = (String)request.getParameter("credit-number");
                    %>
                    <input value="<%out.print(val);%>" maxlength="13" name="credit-number" pattern="\d*" placeholder="Card Number" type="tel"   class="form-control" aria-label="Number" aria-describedby="basic-addon1"/>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <%
                       val = (String)request.getParameter("credit-expires");
                    %>
                    <input value="<%out.print(val);%>" maxlength="5" name="credit-expires" placeholder="MM / YY" type="tel"       class="form-control" aria-label="Number" aria-describedby="basic-addon2"/>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <%
                       val = (String)request.getParameter("credit-cvc");
                    %>
                    <input value="<%out.print(val);%>" maxlength="4" name="credit-cvc" pattern="\d*" placeholder="CVC" type="tel"               class="form-control" aria-label="Number" aria-describedby="basic-addon3"/>
                </div>
