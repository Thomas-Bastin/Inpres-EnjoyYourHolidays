        ...
        <div class="container">
            <form action="Add_Basket" method="POST" id="Add_Basket" >
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="0" aria-label="Number" aria-describedby="basic-addon1" name="nbjours" required min="1" value="1" max="365" >
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" placeholder="0" aria-label="Date" aria-describedby="basic-addon2" name="date" required>
                </div>
