 ...
 * @author Thomas
 */
public class GetListPartResponse implements Response, Serializable{
    ...
    GetListPartResponse(int c, String m){
        code = c;
        message = m;    
        list = new LinkedList<Voyageurs>();
    }
    
    GetListPartResponse(int c, String m, LinkedList<Voyageurs> l){
        code = c;
        message = m;
        
        if(c == SUCCESS){ list = l; }
        else{ list = new LinkedList<Voyageurs>(); }
    }
