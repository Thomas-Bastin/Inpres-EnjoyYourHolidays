 ...
 * @author Arkios
 */
public class Payement_Serveur_Card extends javax.swing.JFrame implements ServerConsole{
    ...
    private synchronized void loadProperties(){
        ...
        try {
            ...
            Logger.getLogger(Payement_Serveur_Card.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Payement_Serveur_Card.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Payement_Serveur_Card().setVisible(true);
        });
    }
